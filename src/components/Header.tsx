...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="section-container">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden xl:flex items-center gap-1">
            {navigation.map((item) => (
              <a
                key={item.href}
                href={item.href}
                className="whitespace-nowrap px-3 py-2 text-sm text-neutral-700 hover:text-neutral-900
          ...
          <button
            ...
            className="xl:hidden p-2 rounded-md text-neutral-600 hover:bg-neutral-100"
      ...
      {mobileOpen && (
        <div className="xl:hidden bg-white border-b border-neutral-100 shadow-lg">
